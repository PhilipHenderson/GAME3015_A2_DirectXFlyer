...
\DoxyCodeLine{00059\ \ \ \ \ \mbox{\hyperlink{class_scene_node}{SceneNode}}(\mbox{\hyperlink{class_game}{Game}}*\ game);}
\DoxyCodeLine{00060\ }
\DoxyCodeLine{00061\ \ \ \ \ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ attachChild(Ptr\ child);}
\DoxyCodeLine{00062\ \ \ \ \ Ptr\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ detachChild(\textcolor{keyword}{const}\ \mbox{\hyperlink{class_scene_node}{SceneNode}}\&\ node);}
\DoxyCodeLine{00063\ }
...
\DoxyCodeLine{00079\ \ \ \ \ \textcolor{keywordtype}{void}\ adjustYaw(\textcolor{keywordtype}{float}\ angle);}
\DoxyCodeLine{00080\ \ \ \ \ \textcolor{keywordtype}{void}\ adjustPitch(\textcolor{keywordtype}{float}\ angle);}
\DoxyCodeLine{00081\ \ \ \ \ \textcolor{keywordtype}{void}\ adjustRoll(\textcolor{keywordtype}{float}\ angle);}
\DoxyCodeLine{00082\ }
\DoxyCodeLine{00083\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00084\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ updateCurrent(\textcolor{keyword}{const}\ GameTimer\&\ gt);}
\DoxyCodeLine{00085\ \ \ \ \ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ updateChildren(\textcolor{keyword}{const}\ GameTimer\&\ gt);}
\DoxyCodeLine{00086\ }
\DoxyCodeLine{00087\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ drawCurrent()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00088\ \ \ \ \ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ drawChildren()\ \textcolor{keyword}{const};}
\DoxyCodeLine{00089\ \ \ \ \ \textcolor{keyword}{virtual}\ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ buildCurrent();}
\DoxyCodeLine{00090\ \ \ \ \ \textcolor{keywordtype}{void}\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ buildChildren();}
\DoxyCodeLine{00091\ }
\DoxyCodeLine{00092\ \textcolor{keyword}{protected}:}
\DoxyCodeLine{00093\ \ \ \ \ \mbox{\hyperlink{class_game}{Game}}*\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ game;}
\DoxyCodeLine{00094\ \ \ \ \ \mbox{\hyperlink{struct_render_item}{RenderItem}}*\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ renderer;}
\DoxyCodeLine{00095\ \ \ \ \ XMFLOAT3\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ mWorldRotation;}
\DoxyCodeLine{00096\ \textcolor{keyword}{private}:}
\DoxyCodeLine{00097\ \ \ \ \ XMFLOAT3\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ mWorldPosition;}
\DoxyCodeLine{00098\ \ \ \ \ XMFLOAT3\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ mWorldScaling;}
\DoxyCodeLine{00099\ \ \ \ \ std::vector<Ptr>\ \ \ \ \ \ \ \ mChildren;}
\DoxyCodeLine{00100\ \ \ \ \ \mbox{\hyperlink{class_scene_node}{SceneNode}}*\ \ \ \ \ \ \ \ \ \ \ \ \ mParent;}
\DoxyCodeLine{00101\ \};}
\DoxyCodeLine{00102\ }
